...
export default function LoginPage() {
  return (
    <div className="loginPageContainer">
      ...
      <picture>
        <source
          srcset={`${ellipseViolet1} 1x, ${ellipseViolet2} 2x, ${ellipseViolet3} 3x, ${ellipseViolet4} 4x`}
        />
        <img className="loginPageEllipseViolet" src={ellipseViolet1} alt="" />
      </picture>
      <picture>
        <source
          srcset={`${ellipseOrange1} 1x, ${ellipseOrange2} 2x, ${ellipseOrange3} 3x, ${ellipseOrange4} 4x`}
        />
